...
const NavBar = () => {
  ...
  return (
    <nav className="z-50 sticky top-0 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 border-b border-blue-400/20 backdrop-blur-md shadow-lg">
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link href={"/"} className="flex items-center gap-1 group hover:opacity-80 transition-opacity">
              <div className="text-2xl font-black tracking-tight">
                ...
                <span className="text-red-500">Taker</span>
              </div>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-1">
            <Link href={"/"}>
              <Button
                variant={"ghost"}
                className="flex items-center gap-2 font-semibold text-blue-200 hover:text-blue-100 hover:bg-blue-400/10"
              >
                <Home size={16} /> Home
              </Button>
            </Link>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <button className="flex items-center gap-2 hover:opacity-80 transition-opacity">
                        <Avatar className="h-9 w-9 ring-2 ring-offset-2 ring-offset-slate-900 ring-blue-500/40 hover:ring-blue-500/60 transition-all cursor-pointer">
                          <AvatarImage
